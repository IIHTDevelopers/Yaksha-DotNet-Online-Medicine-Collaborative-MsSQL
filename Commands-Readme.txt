...
* To connect SQL  server from terminal:
	( OnlineMedicineShopping/sqlcmd -S localhost -U sa -P pass@word1 )
	
	-To create database from terminal - 
	1> Create Database OnlineMedicineShopping_Db
	2> Go
